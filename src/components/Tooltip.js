...
const { Div, Table, Tbody, Tr, Td, Strong } = Html;
//
...
class Tooltip extends React.PureComponent {
  ...
  updateTooltip = () => {
    ...
    const { x, y, horizontalPadding = 0, verticalPadding = 0 } = this.focus;
    ...
    if (align === "auto") {
      if (this.el) {
        ...
        alignPriority.forEach(priority => {
          ...
          if (priority === "left") {
            if (
              space.left - tooltipArrowPadding - padding - horizontalPadding >
                tooltipDims.width &&
            ...
            if (
              space.right - tooltipArrowPadding - padding - horizontalPadding >
                tooltipDims.width &&
              space.top > tooltipDims.height / 2 &&
              space.bottom > tooltipDims.height / 2
            ) {
            ...
            if (
              space.top - tooltipArrowPadding - padding - verticalPadding >
                tooltipDims.height &&
            ...
            if (
              space.bottom - tooltipArrowPadding - padding - verticalPadding >
                tooltipDims.height &&
              space.left > tooltipDims.width / 2 &&
              space.right > tooltipDims.width / 2
            ) {
  ...
  render() {
    ...
    const renderProps = {
      ...
      getStyle: datum =>
        datum.getStatusStyle(
          Utils.getStatus(datum, rest.hovered, rest.selected)
        ),
      primaryAxes,
      secondaryAxes,
      primaryAxis,
