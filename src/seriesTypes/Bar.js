...
class Bar extends React.PureComponent {
  ...
  static plotDatum = (datum, { xAxis, yAxis, primaryAxis, secondaryAxis }) => {
  ...
  static buildStyles = (
    series,
    { getStyles, getDatumStyles, defaultColors }
  ) => {
    const defaults = {
          ...
          return (
            <Rectangle
              style={{
                ...
                ...dataStyle.rectangle,
                pointerEvents:
                  interactiveSeries || interactiveDatum ? "all" : "none"
              }}
              key={i}
